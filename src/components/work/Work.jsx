  ...
  <section id="work" className="section work">
    ...
    <div className="section__content work__item">
      ...
      <ul className="info">
        <li>跨部門合作 :
          <ul>
            <li>1. 與業務部門溝通協作了解醫院端需求，統籌標案和報價合約內容，並滿足客戶需求。</li>
            <li>2. 協助業務導入產品認證服務系統，讓醫院使用產品系統可以更快速完成產品審查作業。</li>
            <li>3. 向其他經銷商，協調借調骨材以供醫院使用。</li>
            <li>4. Zimmer 原廠庫房聯絡窗口，與管理階層溝通與執行瑕疵品/即期品退換進程。</li>
          </ul>  
        </li>
        <li>客戶痛點排除 :  腦力激盪具有建設性的解決方案，透過引導式問句，讓客戶有脈絡地描述當前的問題，並提供建議協助客戶解決當下遭遇的問題。</li>
        <li>醫院報價單與標案製作 :  依據公司預算需求與定價，製作能夠降低成本，增加獲利的報價單與合作標案給客戶。</li>
        <li>財務報表製作與執行 :  統籌 trauma 與骨泥產品線財務報表製作。</li>
        <li>貨品採購與盤點 :  使用 ERP 貨品進銷存管理盤點及採購骨材。</li>
      </ul>
    </div>
    ...
    <div className="section__content work__item">
      ...
      <p className="summary">
        ...
        執行公司各項行銷宣傳影片製作與剪輯，在職期間獲得快速學習新事物與解決問題的超能力，並且能因應不同的需求與主管進行溝通，產出符合公司需求的成果。
      </p>
      <ul className="info">
        <li>活動企劃與執行 :  統籌機構各項活動企劃及相關行政作業,包含計畫說明會講座、雇主見面活動執行。</li>
        <li>社群小編 :  官網部落格文章製作與管理、Instagram＆Facebook 文章投放、社群文案撰寫。</li>
        <li>行銷影片製作 :  公司產品活動宣傳影片製作與剪輯，提升公司曝光率。</li>
      </ul>
    </div>
  </section>
);
